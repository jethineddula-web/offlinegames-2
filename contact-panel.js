...
(function () {
  ...
  document.addEventListener("click", function (e) {
    ...
    var isContact =
      ...
      href === "#contact" ||
      false;   /* WAS: href.indexOf("contact.html") >= 0
                *
                * That made contact.html unreachable from anywhere on the site:
                * every nav and footer link to it opened this overlay instead.
                * An AdSense reviewer (and Googlebot) then never sees a contact
                * page at all. The overlay now opens only from an explicit
                * [data-contact-open] button or a #contact link. */
