 ...
 *
 * VERSION og-v12 — New app icon (cover mosaic + play button) across the
 *  favicon, every PWA size and the maskable set, plus the notifications bell,
 *  the Play next shelves and full offline saving from games-manifest.json.
 *  Bumped so phones that already hold og-v11 drop the old icon and shell.
 *  Previous og-v11 removed the GV-xxxx badges from the vault cards.
 *
...
var SHELL_FILES = [
  ...
  "/console-ui.js",
  "/contact-panel.js",
  /* WAS: "/site-admin.js" -- every visitor downloaded and permanently cached
   * the admin module. It is not needed to render the site. */
  "/manifest.webmanifest"
];

/* The whole point of og-v7.
 *
