...
export function createUi(stage, hooks) {
    ...
    <section class="apex-screen hidden" data-screen="garage">
      ...
      <div class="apex-scroll">
        ...
        <div class="apex-actions" style="margin-top:16px">
          <button class="apex-btn" data-act="watch-coins">Collect 200 bonus coins</button>
        </div>
      </div>
    ...
    <div class="apex-modal hidden" data-modal="results">
      <div class="apex-panel">
        ...
        <div class="apex-actions">
          ...
          <button class="apex-btn" data-act="extra-life" data-extra>Take an extra life</button>
  ...
  `;
    ...
    function watchAd(kind, onDone) {
        // AdSense policy: no reward in exchange for viewing an ad outside the
        // official H5 Games Ads (adBreak) API. Granted outright.
